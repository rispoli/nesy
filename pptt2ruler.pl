...
tp(s(Phi, Psi), (R, O, P, [I], S, [[r(s(Phi, Psi))]])) :-
    ...
    findall(r(qm(Phi, s(Phi, Psi), X)), (member(X_, Q_Phi), foldl1(and, X_, X)), Rqm_Phi),
    findall(r(qm(Psi, s(Phi, Psi), Y)), (member(Y_, Q_Psi), foldl1(and, Y_, Y)), Rqm_Psi),
...
tp(z(Phi, Psi), (R, O, P, [I], S, [[r(z(Phi, Psi))]])) :-
    !, tp(Phi, (R_Phi, O_Phi, P_Phi, _, S_Phi, Q_Phi)),
    tp(Psi, (R_Psi, O_Psi, P_Psi, _, S_Psi, Q_Psi)),
    findall(r(qm(Phi, z(Phi, Psi), X)), (member(X_, Q_Phi), foldl1(and, X_, X)), Rqm_Phi),
    findall(r(qm(Psi, z(Phi, Psi), Y)), (member(Y_, Q_Psi), foldl1(and, Y_, Y)), Rqm_Psi),
    union(Rqm_Phi, Rqm_Psi, Rqm),
